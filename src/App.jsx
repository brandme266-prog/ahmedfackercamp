...
const ARTICLES = [
  ...
  },
  {
    ...
    excerpt: 'السيرة الذاتية لـ "الشركة الإسلامية": كيف تحولت ورشة هندسية إلى أكبر صرح لتصنيع مكن الرخام، الجلايات، والأوناش الثقيلة في شق التعبان والشرق الأوسط.',
    content: `
...
const FAQS = [
  {
    ...
    a: 'تختلف اسعار مكن الرخام بناءً على نوع الماكينة (منشار، جلاية، أو ونش) والمواصفات المطلوبة. في الشركة الإسلامية، نقدم أفضل مصنع مكن رخام بأسعار تنافسية جداً مقارنة بالمستورد، مع توفير خصومات خاصة لتجهيز المصانع الجديدة بالكامل (خطوط الإنتاج والأوناش) مع تسهيلات في أنظمة الدفع.'
  },
  {
