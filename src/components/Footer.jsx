        ...
        <div className="footer-grid">
          <div className="footer-about">
            ...
            <div className="footer-social-links">
              ...
              <a href="https://www.instagram.com/eng_ahmedfekry" target="_blank" rel="noopener noreferrer" className="social-btn" aria-label="انستجرام">
              ...
              <a href="https://www.tiktok.com/@eng.ahmed.fekry" target="_blank" rel="noopener noreferrer" className="social-btn" aria-label="تيك توك">
                <svg width="20" height="20" fill="currentColor" viewBox="0 0 24 24"><path d="M19.59 6.69a4.83 4.83 0 01-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 01-2.88 2.5 2.89 2.89 0 01-2.89-2.89 2.89 2.89 0 012.89-2.89c.28 0 .54.04.79.1v-3.5a6.37 6.37 0 00-.79-.05A6.34 6.34 0 003.15 15.2a6.34 6.34 0 006.34 6.34 6.34 6.34 0 006.34-6.34V8.93a8.16 8.16 0 004.76 1.52v-3.4a4.85 4.85 0 01-1-.36z"/></svg>
              </a>
              <a href="https://x.com/mdfkry14" target="_blank" rel="noopener noreferrer" className="social-btn" aria-label="اكس">
